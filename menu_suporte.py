...
class Frame_menu_suporte(object):
    ...
    def __init__(self, queue_thread, **kw):
        ...
        builder.add_from_file(os.path.join(CURRENT_DIR, 'menu_suporte.ui'))
        self.root = builder.get_object('main')
        self.root.title("Menu Suporte")
    ...
    def seleciona_img_canvas(self, objeto, imagem, altura_imagem, largura_imagem):
        ...
        while validador is False:
            ...
            try:
                ...
                # INSERINDO A IMAGEM
                validador = Frame_menu_suporte.insere_img_canvas(self, objeto, img, altura_imagem, largura_imagem)
    ...
    def carrega_img_canvas(self, objeto, imagem, altura_imagem, largura_imagem):
        ...
        try:
            ...
            Frame_menu_suporte.seleciona_img_canvas(self, canvas_logo, imagem, altura_imagem, largura_imagem)
        except Exception as ex:
            print(ex)
    ...
    def voltar_main_menu(self):
        ...
        self.mainmenu = True
        Frame_menu_suporte.fecha_frame(self)


    def bt_desenvolvedores(self):

        """

            FUNÇÃO APÓS O CLICK SOBRE O BOTÃO
            INFORMA SOBRE OS DESENVOLVEDORES RESPONSÁVEIS PELO PROJETO.
    ...
    def bt_versao(self):
        ...
        try:
            ...
            print(ex)
            Frame_Atuacao.registra_erro(self, os.getlogin(), "Frame_Atuacao.bt_menu_sobre_versao_click", str(ex))
    ...
    def bt_ajuda(self):
        ...
        """
            ...
            FUNÇÃO APÓS O CLICK SOBRE O BOTÃO
            ABRE UM PAINEL PARA FORNECER AJUDA AOS USUARIOS.
            ESSA FUNÇÃO ESTÁ HABILITADA PARA TODOS USUÁRIOS.
...
def Orquestrador_Menu_Suporte():
    ...
    # INICIANDO O APP
    app_proc = Frame_menu_suporte(queue_thread)

    # CONFIGURANDO
    app_proc.centraliza_janela()

    # INSERINDO FUNDO
    app_proc.carrega_img_canvas("fundo", "fundo_suporte.jpg", 0, 0)

    # APLICANDO A IMAGEM NOS BOTÕES
    app_proc.imagem("Bt_ajuda", "menu_ajuda.png")
    app_proc.imagem("Bt_desenvolvedores", "menu_desenvolvedores.png")
    app_proc.imagem("Bt_versao", "menu_versao.png")
...
if __name__ == '__main__':
    sys.exit(Orquestrador_Menu_Suporte())
