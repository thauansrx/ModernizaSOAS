...
class Frame_menu_cadastro(object):
    ...
    def __init__(self, queue_thread, **kw):
        ...
        builder.add_from_file(os.path.join(CURRENT_DIR, 'menu_cadastro.ui'))
        self.root = builder.get_object('main')
        self.root.state('zoomed')
        self.root.title("Menu Cadastro")
    ...
    def voltar_main_menu(self):
        ...
        self.mainmenu = True
        Frame_menu_cadastro.fecha_frame(self)


    def bt_cadastrar_colaboradores(self):

        """

            FUNÇÃO APÓS O CLICK SOBRE O BOTÃO
            ABRE UMA PAINEL PARA CADASTRAR COLABORADORES.
            ESSA FUNÇÃO ESTÁ HABILITADA APENAS PARA ALGUNS USUÁRIOS.
    ...
    def bt_cadastrar_produtos(self):

        """

            FUNÇÃO APÓS O CLICK SOBRE O BOTÃO.
            ABRE UM PAINEL CONTENDO PARA CADASTRAR PRODUTOS.
            ESSA FUNÇÃO ESTÁ HABILITADA APENAS PARA ALGUNS USUÁRIOS.
    ...
    def seleciona_img_canvas(self, objeto, imagem, altura_imagem, largura_imagem):
        ...
        while validador is False:
            ...
            try:
                ...
                # INSERINDO A IMAGEM
                validador = Frame_menu_cadastro.insere_img_canvas(self, objeto, img, altura_imagem, largura_imagem)
    ...
    def carrega_img_canvas(self, objeto, imagem, altura_imagem, largura_imagem):
        ...
        try:
            ...
            Frame_menu_cadastro.seleciona_img_canvas(self, canvas_logo, imagem, altura_imagem, largura_imagem)
        except Exception as ex:
            print(ex)
...
def Orquestrador_Menu_Cadastro():
    ...
    # INICIANDO O APP
    app_proc = Frame_menu_cadastro(queue_thread)

    # CONFIGURANDO
    app_proc.centraliza_janela()

    # INSERINDO FUNDO
    app_proc.carrega_img_canvas("fundo", "fundo_cadastro.jpg", 0, 0)

    # APLICANDO A IMAGEM NOS BOTÕES
    app_proc.imagem("Bt_produtos", "menu_cadastrar_produtos.png")
    app_proc.imagem("Bt_colaboradores", "menu_cadastrar_colaboradores.png")
...
if __name__ == '__main__':
    sys.exit(Orquestrador_Menu_Cadastro())
